...
<?php echo $this->Form->create('Srna');?>
	<fieldset>
        ...
        <table><tr>
        <td style="width:60%">
        <?php echo $this->Form->input('start', array('label' => 'Coordinates between', 'class' => 'short_input', 'div' => array('style' => 'display:inline'))); ?>
        <?php echo $this->Form->input('stop', array('label' => false, 'class' => 'short_input', 'div' => array('style' => 'display:inline'))); ?>
        </td>
        <td>
