<div class="abundancies form">
<?php echo $this->Form->create('Abundancy');?>
	<fieldset>
 		<legend><?php __('Edit Abundancy'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Abundancy.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Abundancy.id'))); ?></li>
