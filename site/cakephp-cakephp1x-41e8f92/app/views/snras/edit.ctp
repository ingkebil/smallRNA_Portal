...
<?php echo $this->Form->create('Snra');?>
	<fieldset>
 		<legend><?php printf(__('Edit %s', true), __('Snra', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Snra.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Snra.id'))); ?></li>
